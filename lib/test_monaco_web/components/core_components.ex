defmodule TestMonacoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestMonacoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestMonacoWeb.Gettext, "errors", msg, opts)
    end
  end
